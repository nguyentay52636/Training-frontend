...
export const createPoint = async ({ maSV, tenSV,diemChuyenCan, diemThucHanh, diemGiuaKy, diemCuoiKy, bangDiemMon, hocKy, nam, lop }: PointType) => {
...
export const updatePoint = async (idCotDiem: number, { maSV,tenSV, diemChuyenCan, diemThucHanh, diemGiuaKy, diemCuoiKy, bangDiemMon, hocKy, nam, lop }: PointType) => {
    const point: PointType = {
        maSV: maSV,
        tenSV: tenSV,
        diemChuyenCan: diemChuyenCan,
