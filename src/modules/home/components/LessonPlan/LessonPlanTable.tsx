...
import { useGetKeHoachDayHoc } from './qeurys';
import DeleteThongTinChungDialog from './DeleteLessonPlanDialog';
import EditThongTinChungDialog from './EditLessonPlanDialog';

export default function LessonPlanTable() {
  const { data } = useGetKeHoachDayHoc();
