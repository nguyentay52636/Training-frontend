...
import { HocPhan } from "../ProgramContent/components/DataBlock";

import { Plus } from "lucide-react";
import khoiKienThucData from "../ProgramContent/components/DataBlock";
    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Button className='bg-indigo-700  rounded-xl block ml-auto  cursor-pointer'>Thêm chuyên ngành</Button>
            </DialogTrigger>
