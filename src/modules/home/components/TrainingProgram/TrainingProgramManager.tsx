    ...
    return (
        <div className="min-h-screen bg-white p-6">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={() => navigate("/dashboard/trainingprogram/skeletonprogram")} className="flex items-center gap-2 px-4 py-2 text-white rounded-lg bg-gradient-to-r from-blue-200 to-indigo-700 hover:from-blue-300 hover:to-indigo-800 transition-all">
