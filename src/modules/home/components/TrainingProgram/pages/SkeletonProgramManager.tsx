...
const TabNavigation = () => (
  <TabsList className='grid w-full grid-cols-4 mb-6 bg-gray-200 rounded-md h-20 '>
    <TabsTrigger value='general' className='hover:bg-white! cursor-pointer'>
      <div className='rounded-full bg-gradient-to-r from-blue-600 to-indigo-300 hover:from-blue-700 hover:to-indigo-800 px-3 py-0.5 font-bold text-xl mx-2'>
        1
      </div>{' '}
    ...
    >
      <div className='rounded-full bg-gradient-to-r from-blue-600 to-indigo-300 hover:from-blue-700 hover:to-indigo-800 px-2.5 py-0.5 font-bold text-xl mx-2'>
        2
      </div>{' '}
      <h1 className='font-bold text-xl'>Đề cương chi tiết</h1>
    </TabsTrigger>
    ...
    >
      ...
      <h1 className='font-bold text-xl'>Danh mục khối kiến thức</h1>
    </TabsTrigger>
    ...
    >
      ...
      <h1 className='font-bold text-xl'>Kế hoạch dạy học</h1>
    </TabsTrigger>
  </TabsList>
);
